        ...
        <header className="bg-white dark:bg-gray-900 shadow-[0_1px_4px_rgba(0,0,0,0.1)] relative z-50">
            <div className="max-w-7xl mx-auto px-3 py-3 flex flex-col items-center gap-2 sm:flex-row sm:justify-between sm:px-6 sm:py-4">
                ...
                <nav className="flex items-center text-gray-700 dark:text-gray-300 text-[12px] sm:text-[18px]" style={{ gap: "5px" }}>
                    ...
                    <Link href="https://docs.google.com/forms/d/e/1FAIpQLSfvFkHs98DUzwh0qH3iplBqid4s6yeMcZjpkZwD1Om0AHSSbA/viewform" target="_blank" rel="noopener noreferrer" className="bg-[#008409] dark:bg-green-700 text-white px-4 py-1.5 rounded-md shadow hover:bg-[#15711b] dark:hover:bg-green-800 transition text-[13px] sm:text-[15px] whitespace-nowrap">
                        Take Our Survey
                    </Link>
                </nav>
