...
<div className="flex flex-col gap-3">
    <FormulaBlock
        ...
        formula="\sum F_x = 0,\; \sum F_y = 0,\; \sum F_z = 0"
    />
    <FormulaBlock
        label="Moment Equations"
        formula="\sum M_x = 0,\; \sum M_y = 0,\; \sum M_z = 0"
    />
</div>
                </div>
                ...
                <div className="w-full max-w-xl">
                    ...
                    <Step number={5} title="Apply Equilibrium Equations">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-1">                            <FormulaBlock label="Force Equilibrium"  formula="\sum \mathbf{F} = 0" />
...
formula="\begin{aligned}\sum F_x &= 0,\; \sum F_y = 0,\; \sum F_z = 0 \\ \sum M_x &= 0,\; \sum M_y = 0,\; \sum M_z = 0\end{aligned}"
                        />
                    </Step>
