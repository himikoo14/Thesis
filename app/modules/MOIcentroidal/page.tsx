...
function FormulaBlock({ label, formula }: FormulaBlockProps) {
  return (
    <div className="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl p-4 my-3 text-center">
      ...
      <div className="text-[13px] sm:text-[18px] dark:[&_.katex]:text-white dark:[&_.katex-html]:text-white">
...
`,
      ...
      <main className="flex-grow flex flex-col items-center px-4 py-10">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-8 text-center">About the Centroidal Axis</p>
        ...
        <div className="w-full max-w-xl">
          ...
          <Step number={1} title="Divide the Composite Area">
            <p>Split the area into simple parts or shapes.</p>
