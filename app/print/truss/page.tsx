...
function JointFBD({
    ...
    const rxn = solution?.reactions?.find(
        (r: any) => r.node === jointIdx
    );
    ...
    return (
        ...
        >
            ...
            {arrows.map((arrow, idx) => {
                const len = 40 + (arrow.magnitude / maxForce) * 55;
                const x2 = 130 + Math.cos(arrow.angle) * len;
                const y2 = 130 - Math.sin(arrow.angle) * len;
                        ...
                        {parsed.solution.lines.map((line: any, i: number) => {
                            ...
                            if (line.kind === "jointFBD") {
                                return (
                                    ...
                                    >
                                        <div className="font-semibold text-[#1848a0] mb-3">
